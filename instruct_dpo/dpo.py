"""
dpo.py -- stage 8's logic: Direct Preference Optimization, AND the shared sequence-scoring
...
2. THE STAGE RUNNER -- run(), the preference training loop, which starts from the SFT
   model and trains it against the frozen SFT reference. stage8_instruct_dpo.sh is only
