"""
tools/config_wizard.py -- write config_user.yaml, your own settings for a run.

    python -m tools.config_wizard                   # ask, then write config_user.yaml
    python -m tools.config_wizard --show            # print what would be written, write nothing
    python -m tools.config_wizard --defaults        # accept every default, no questions
    python -m tools.config_wizard --out other.yaml  # write somewhere else
...
def render(answers):
    ...
    lines = [
        "# config_user.yaml -- your settings. Generated by tools/config_wizard.py.",
        "#",
