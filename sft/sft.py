"""
sft.py -- stage 4's logic: domain-adaptive supervised fine-tuning on the fine-tuning data.

The objective is the SAME length-normalized LM likelihood as pretraining (lm.train); what
changes is the corpus. Stage 3 buys general language from a large heterogeneous corpus,
...
def load_corpus(tok, corpus_dir, log=print):
    ...
    nothing else -- the rejected one is what stages 5 and 8 need, and feeding it here would
